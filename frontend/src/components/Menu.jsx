...
import { AppBar, Toolbar, Box, Typography, Menu as MuiMenu, MenuItem } from "@mui/material"; // Renamed Menu import to MuiMenu
      ...
      <Toolbar sx={{ display: "flex", justifyContent: "space-between", height: 60 }}>
        ...
        <Box display="flex" alignItems="center">
          ...
          <div onMouseEnter={handleMenuOpen} onMouseLeave={handleMenuClose}>
            ...
            <MuiMenu  // Using the renamed MuiMenu
              id="admin-menu"
              anchorEl={anchorEl}
...
export default Menu; // Keeping the custom component as 'Menu'
